...
// Low-level `.jsonl` parsing seam (line-safe reads, content flattening, tool-call
// signatures, elapsed-time math, trajectory companion parse) lives in its own
// module so this file focuses on session assembly and the public API.
