 ...
 * reduce non-determinism, wraps a backend with adversarial framing
 * (weakness-first, strict scoring, anti-injection markers), and provides a
 * cross-model judge that delegates to a different model. Also exposes the
 * consensus / adversarial assertion factories built on these.
 *
