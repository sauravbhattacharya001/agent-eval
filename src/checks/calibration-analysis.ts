 ...
 *
 * Runs a model-as-judge against a calibration set of pre-scored examples,
 * measures how closely it matches human-assigned ground truth (exact-match /
 * within-one / mean-absolute-error / bias), builds calibration sets via a
 * fluent builder, and detects judge drift between two snapshots.
 *
 * Re-exported through the public barrel (`./calibration.js`); the type
 * vocabulary lives in `./calibration-types.js`.
 *
