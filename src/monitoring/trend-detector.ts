 ...
 *   - `./trend-report.js`         — the presentation helpers
 *                                   ({@link hasDegradation}, {@link formatTrendReport})
 *                                   and the display comparators.
 *   - this file                   — bucketing and the public {@link detectTrends}
 *                                   pipeline; re-exports the report helpers.
 *
 * Pipeline shape:
 *
 *     scores.jsonl
...
import { compareBySeverityThenZ, compareTrendsForDisplay } from './trend-report.js';
...
// Re-export the reporting helpers so consumers keep one import path.
export { hasDegradation, formatTrendReport } from './trend-report.js';
