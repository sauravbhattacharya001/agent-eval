 ...
 * (>=2 actionable artifact kinds, `watch` gate). The right thresholds for an
 * opt-in check are an open question - and the right way to settle it is to run the DEFAULT
