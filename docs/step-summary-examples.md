...
> PASS — 1/1 workers within gate (watch), mean score 0.9000

**Gate:** `watch` · **Evaluated:** 1 worker(s) · **Failing:** 0 · **Fleet score:** 0.9000

### Scorecard

**Window:** all-time  
**Generated:** 2026-06-13T12:00:00.000Z  
**Fleet:** 1 worker(s) · 1 run(s) · pass 100% · mean 0.90 · trends ↓0 ↑0

| Worker | Grade | Pass | Mean | Worst | Runs | Trend | Top failures |
|---|---|---:|---:|---:|---:|:---:|---|
| claude-review | OK | 100% | 0.90 | 0.90 | 1 | · | — |
