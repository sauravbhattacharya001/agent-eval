 ...
 *
 * This file is the **public barrel** for format checking and the home of the
 * assertion factories that wrap the engine into Jest/Vitest-style assertions.
 * The supporting seams live alongside it and are re-exported here so the public
 * surface stays a single `./format.js` import path:
